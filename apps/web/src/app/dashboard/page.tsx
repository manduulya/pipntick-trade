...
function AddTradeModal({ onClose, onSaved }: { onClose: () => void; onSaved: (message: string) => void }) {
  ...
  return (
    <div
      ...
      // Deliberately no click-outside-to-close here: this form holds a lot of manually entered
      // data, so an accidental backdrop click shouldn't discard it. Close is via the × button only.
    >
      <div
